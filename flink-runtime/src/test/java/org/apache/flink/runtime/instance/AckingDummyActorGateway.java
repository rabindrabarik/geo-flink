 ...
 */
public class AckingDummyActorGateway implements ActorGateway {
	public static final AckingDummyActorGateway INSTANCE = new AckingDummyActorGateway();
	private static final long serialVersionUID = -833861606769367952L;

	private final String path;

	public AckingDummyActorGateway() {
		this("DummyActorGateway");
	}

	public AckingDummyActorGateway(String path) {
		this.path = path;
	}
	...
	public Future<Object> ask(Object message, FiniteDuration timeout) {
		...
		return new FuturesConvertersImpl.P<>(a);
	}
